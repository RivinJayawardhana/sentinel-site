...
class RAGTool:
    ...
    def __init__(
        ...
        from application.chat_service.cag_cache import CAGCache
        from application.chat_service.rag_service import QdrantRetriever, RAGService
        from application.chat_service.crag_service import CRAGService
        from application.chat_service.cag_service import CAGService
